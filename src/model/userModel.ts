...
const userSchema = new Schema({
  ...
  // ------------------ Basic Info --------------------------//
    ...
    favourite_genre: { type: Array, required: false  ,default:null},
    ...
    major: { type: String, required: false  ,default:null},
    ...
    is_signup_complete: { type: Boolean, default: false},  // Signup complete flag
